package com.jkTech.questionService.model;
...
public class Question {
	...
	public String toString() {
		return "Question [id=" + id + ", category=" + category + ", difficultyLevel=" + difficultyLevel
				+ ", questionTitle=" + questionTitle + ", option1=" + option1 + ", option2=" + option2 + ", option3="
				+ option3 + ", option4=" + option4 + ", quesrightAnswer=" + quesrightAnswer + "]";
	}
